...
public class NUmberOfMostGivenNinSortedSet {
	public static void main(String[] args) {
		NUmberOfMostGivenNinSortedSet n=new NUmberOfMostGivenNinSortedSet();
		String D[]= {"1","3","5","7"};
		int N=8986;
		System.out.println(n.atMostNGivenDigitSet(D, N));
	}
